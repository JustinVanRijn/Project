	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				<a href="#" class="navbar-brand">VuurwerkWinkel</a>
			</div>
			<ul class="nav navbar-nav">
				<li><a href="index.php"><span class="glyphicon glyphicon-home"></span>Home</a></li>
				<li><a href="index.php"><span class="glyphicon glyphicon-modal-window"></span>Producten</a></li>
			</ul>
		</div>
	</div>
	<p><br/></p>
								...
								while ($row=mysqli_fetch_array($query)) {
									?>
										<div class="row">
											...
											<div class="col-md-6">
												<table>
													<tr><td>Product Naanm</td><td><b><?php echo $row["product_title"]; ?></b> </td></tr>
													<tr><td>Product Prijs</td><td><b><?php echo "$ ".$row["product_price"]; ?></b></td></tr>
													<tr><td>Aantal</td><td><b><?php echo $row["qty"]; ?></b></td></tr>
